...
| 문서 | 설명 |
|------|------|
| [`PRD.md`](./PRD.md) | PRD v1 (F1~F10 원본) |
| [`readout-features.md`](./readout-features.md) | Readout 기능 명세서 (677줄) |
| [`readout-analysis.md`](./readout-analysis.md) | Readout 기술 분석서 (1,519줄) |
| [`agentation-analysis.md`](./agentation-analysis.md) | Agentation 기능 분석서 (375줄) |
| [`user-concerns.md`](./user-concerns.md) | 사용자 고민 → 기능 매핑 (337줄) |
