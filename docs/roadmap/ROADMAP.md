...
| 2 | 세션 리플레이 | **진행중** (M1/M3/M4/M5/M7 완료, M2/M6 부분) | [phase-2-replay.md](./phase-2-replay.md) |
| 3 | 분석 및 확장 | **진행중** (M1/M2/M3/M4/M7 완료 + M5 거의/M6 부분) | [phase-3-analysis.md](./phase-3-analysis.md) |
