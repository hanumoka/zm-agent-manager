...
| 2 | 세션 리플레이 | **진행중** (M1-M5 완료, M2/M6/M7 부분) | [phase-2-replay.md](./phase-2-replay.md) |
| 3 | 분석 및 확장 | **진행중** (M2 검색 3/4) | [phase-3-analysis.md](./phase-3-analysis.md) |
| Q | 품질 — E2E 테스트 + 런타임 오류 수정 | **착수 예정** | (테스트 인프라 + 10건 이슈 수정) |
...
- [ ] Q3: Playwright `_electron` E2E 인프라 구축
- [ ] Q4: 사이드바 6개 페이지 smoke test 작성
- [ ] Q5: Electron MCP 서버 도입 (탐색 테스트)
- [ ] Q6: GitHub Actions CI 통합 (macOS + Linux)
